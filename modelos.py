...
class Estrategia:
    def __init__(self, segmento="", cotacao_atual_minima=0, ffo_yield_minimo=0, dividiend_yeld_minimo=0, p_vp_minimo=0,
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.dividiend_yield < self.dividiend_yeld_minimo\
